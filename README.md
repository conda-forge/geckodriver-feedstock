...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/geckodriver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/geckodriver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add geckodriver
# for installing globally
pixi global install geckodriver
```
...
It is possible to list all of the versions of `geckodriver` available on your platform:
...
```
pixi search geckodriver --channel conda-forge
```
